...
from espnet2.layers.stft_check import Stft
...
class TFMaskingNet1(AbsEnhancement):
    ...
    def forward(self,uttid, input: torch.Tensor, ilens: torch.Tensor):
        """Forward.
        ...
        # batch size=1 case
        #input_spectrum_file="/home4/md510/w2020/espnet-recipe/enhancement_on_espnet2/exp_8k_1/enh_train_enh_tf_mask_magnitude3_same_data_Ach_train_8k_8k_raw/enhanced_data_Ach_train_8k_10/output_of_stft_file.pkl"
        ...
        #input_spectrum_mat_2 = input_spectrum_mat_2.to(ilens.device)
        #input_spectrum = input_spectrum_mat_2 
        ...
        logging.info(f"in the tf_mask_net1 forward function, output is self.stft is from pkl file {input_spectrum} its shape is {input_spectrum.shape}")
        ...
        #input_mganitude_mvn_file="/home4/md510/w2020/espnet-recipe/enhancement_on_espnet2/exp_8k_1/enh_train_enh_tf_mask_magnitude3_same_data_Ach_train_8k_8k_raw/enhanced_data_Ach_train_8k_10/input_of_rnn_file.pkl"
        #with open (input_mganitude_mvn_file, "rb") as f:
        #    input_magnitude_mvn_1= pickle.load(f)
        #if uttid[0]  in input_magnitude_mvn_1:
        #    input_magnitude_mvn_2 = input_magnitude_mvn_1[uttid[0]]
        #input_magnitude_mvn_2 = input_magnitude_mvn_2.to(ilens.device)
        #x, flens, _ = self.rnn(input_magnitude_mvn_2, flens)
        #logging.info(f"in the tf_mask_net1 forward function, input of self.rnn is from pkl file  is {input_magnitude_mvn_2} its shape is {input_magnitude_mvn_2.shape}")
        ...
        #with open(args.input_magnitude_mvn, "wb") as f:
        #    input_magnitude_mvn = {"mean": mean, "std": std}
