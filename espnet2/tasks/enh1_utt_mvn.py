...
from espnet2.enh.nets.tf_mask_net1_utt_mvn import TFMaskingNet2
#from espnet2.enh.nets.tf_mask_net1_check import TFMaskingNet1
...
enh_choices = ClassChoices(
    name="enh",
    classes=dict(tf_masking=TFMaskingNet, tf_masking1=TFMaskingNet1, tf_masking2=TFMaskingNet2,tasnet=TasNet, wpe_beamformer=BeamformerNet),
