...
from espnet2.asr.espnet_model_speaker_extraction import ESPnetASRModel
...
frontend_choices = ClassChoices(
    name="frontend",
    classes=dict(default=DefaultFrontend, sliding_window=SlidingWindow, cnn=CNNFrontend),
