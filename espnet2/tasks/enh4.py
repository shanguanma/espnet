...
from espnet2.enh.espnet_model4 import ESPnetEnhancementModel
...
from espnet2.enh.nets.tf_mask_net4 import TFMaskingNet4
...
enh_choices = ClassChoices(
    name="enh",
    classes=dict(tf_masking=TFMaskingNet, tasnet=TasNet, wpe_beamformer=BeamformerNet,tf_masking4=TFMaskingNet4,),
