...
###        text_ref1 = text_ref1[:, :text_length_max]
        ...
        """
        loss_enh, perm, predicted_magnitude, tf_length  = self.forward_enh(
            speech_mix,
            speech_mix_lengths,
        ...
        # 1. Encoder
        logging.info(f"in the forward fucntion in espnet_joint_model3.py,predicted_magnitude is {predicted_magnitude} its shape is {predicted_magnitude.shape}")
        logging.info(f"in the forward fucntion in espnet_joint_model3.py, tf_length is {tf_length}")
...
###        text_ref_lengths = text_ref1_lengths
    ...
    def inference(
        ...
        **kwargs,
        ...
        predicted_magnitude, tf_length, _ = self.enh_model(
            speech_mix, speech_mix_lengths,
        )

        assert speech_mix.shape[0] == predicted_magnitude[0].shape[0]
    ...
    def encode(
        ...
        logging.info(f"in the espnet_joint_model3.py, input of self.normalize is {feats} and its lengths is {feats_lengths}")
    ...
    def forward_enh(
        ...
        **kwargs,
        ...
        return loss, perm, predicted_magnitude[0], tf_length
