...
class ESPnetEnhASRModel(AbsESPnetModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        samps = predicted_wav.numpy() # (sample_point,)
        samps_int16 = (samps * MAX_INT16).astype(np.int16)
        predicted_wav_tensor = torch.tensor(samps_int16, device=speech_mix_lengths.device, dtype=torch.float32)
        speech_mix = predicted_wav_tensor 
