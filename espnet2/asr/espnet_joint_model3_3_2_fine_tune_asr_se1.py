...
### using daymic rate for enh_loss and asr_loss
"""
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.enh_weight == 0.0:
            ...
            # using daymic rate
            new_ratio = loss_asr/loss_enh
            dynamic_ratio = 0.9 * 1 + 0.1 * new_ratio
            loss = (1 - self.enh_weight) * loss_asr + self.enh_weight * (loss_enh * dynamic_ratio)
