...
from espnet2.tasks.enh_asr2_3_2_fine_tune_asr_se1 import ASRTask
...
class Speech2Text:
    ...
    def __init__(
        ...
        token_type: str = None,
        non_linguistic_symbols: str = Union[Path, str, Iterable[str]] = None 
        bpemodel: str = None,
        device: str = "cpu",
        ...
        if token_type is None:
            ...
            tokenizer = build_tokenizer(token_type=token_type, non_linguistic_symbols=non_linguistic_symbols)
